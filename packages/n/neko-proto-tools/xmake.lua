package("neko-proto-tools")
    ...
    add_versions("git:0.2.5", "fa48c165864f80ca7aa8b98c19713a24b5b08e894890b01b07073ff7f2f50643")
    add_versions("github:0.2.5", "2f21adc8edfc3ed51e6cccdb9625a85c1d2347a9")
